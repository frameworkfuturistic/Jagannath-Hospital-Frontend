...
export default function RootLayout({
  ...
  const menuItems = [
    ...
    { icon: LineChart, label: 'Gallery', href: '/dashboard/gallery' },
    {
      icon: FileText,
      label: 'Contact Us',
      href: '/dashboard/masters/contactus',
    },
  ];
  const masterSubmenuItems = [{ label: 'Departments', href: '#' }];
  ...
  return (
    ...
    >
      {/* Desktop Sidebar */}
      <aside
        className={`hidden lg:flex flex-col space-y-5 p-5 bg-white dark:bg-gray-800 shadow-lg rounded-r-3xl fixed h-screen z-50 ${
            ...
            <div key={item.href}>
              {item.label === 'Master' ? (
                <>
                  ...
                  {isMasterSubmenuOpen && !isSidebarCollapsed && (
      ...
      >
        {/* Header */}
        <header className="flex items-center justify-between p-4 bg-white dark:bg-gray-800 shadow-md rounded-b-3xl sticky top-0 z-40">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="relative bg-gray-100 dark:bg-gray-700 rounded-full"
                >
