  ...
  const renderDashboardCards = () => (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      ...
      <DashboardCard
        ...
        value={
          applicationsQuery.data?.filter((app) => app.status === 'Applied')
            .length || 0
        }
                            ...
                            <DropdownMenuItem
                              ...
                              onClick={() =>
                                handleUpdateApplication({
                                  ...application,
                                  status: status as ApplicationForm['status'],
                                })
                              }
                            >
                              Mark as {status}
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <JobDialog
        ...
        job={selectedJob}
        onSubmit={(data) =>
          selectedJob ? handleUpdateJob(data as Job) : handleCreateJob(data)
        }
      />
...
function JobDialog({
  ...
  onClose: () => void;
  job: Job | null;
  onSubmit: (data: Omit<Job, '_id'> | Job) => void;
}) {
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select
              ...
              onValueChange={(value) =>
                onUpdateStatus({
                  ...application,
                  status: value as ApplicationForm['status'],
                })
              }
            >
