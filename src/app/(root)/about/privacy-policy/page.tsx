      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div key={`${section.title}-content-${contentIndex}`}>
                      ...
                      <ul className="list-disc list-inside space-y-2">
                        {contentItem.text.map((paragraph, paraIndex) => (
                          <li
                            key={`${section.title}-para-${contentIndex}-${paraIndex}`}
        ...
        >
          ...
          <p className="mb-10 text-lg sm:text-xl max-w-2xl mx-auto">
            Our team is here to help you understand our commitment to quality,
            environmental responsibility, and safety. We're dedicated to
