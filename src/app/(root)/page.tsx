...
const Ourmedical = dynamic(() => import('@/components/Ourmedical'), {
  ssr: false,
});
const Ourservice = dynamic(() => import('@/components/Ourservice'), {
  ssr: false,
});
const PatientsReview = dynamic(() => import('@/components/PatientReview'), {
  ssr: false,
});
const CarouselDemo = dynamic(
  () => import('@/components/sliderImg').then((mod) => mod.CarouselDemo),
  { ssr: false }
);
const OurHeads = dynamic(() => import('@/components/OurHeads'), { ssr: false });
const NoticeSlider = dynamic(
  () => import('@/components/NoticeSlider').then((mod) => mod.NoticeSlider),
  { ssr: false }
);
const BlogCards = dynamic(() => import('@/components/BlogCards'), {
  ssr: false,
});
const WhatsAppWidget = dynamic(() => import('@/components/widget/WhatsApp'), {
  ssr: false,
});
...
const Dashboard = () => {
  ...
  const opacity = useSpring(
    useTransform(scrollYProgress, [0, 0.5, 1], [1, 0.85, 0])
  );
