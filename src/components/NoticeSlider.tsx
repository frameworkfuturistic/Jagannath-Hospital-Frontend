    ...
    <section className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <Marquee className="bg-primary text-white font-mono font-semibold text-xl w-full h-12 rounded-t-xl mb-6">
        ...
        {announcements.map((announcement, index) => (
          <span key={announcement._id} className="mr-8">
            {announcement.title}
                    ...
                    <Card className="shadow-xl overflow-hidden">
                      <CardContent className="p-0 relative">
                        {announcement.thumbnailImage ? (
                          <Image
                            src={announcement.thumbnailImage} // Your image source
                            alt={announcement.title} // Alt text for accessibility
                            width={1200} // Set the width (you can adjust)
                            height={400} // Set the height (you can adjust)
              ...
              {loading ? (
                ...
                announcements.map((announcement) => (
                  <Card
                    ...
                    className="shadow-sm bg-gradient-to-r from-teal-50 to-teal-50 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
                  >
                          ...
                          <div className="flex justify-between items-center mt-2">
                            ...
                            <div className="flex space-x-1">
                              <Badge
                                ...
                                )} text-white hover:bg-primary text-xs px-2 py-0.5`}
                              >
                                {announcement.priority}
                              </Badge>
                              <Badge
      ...
      <Dialog
        ...
        onOpenChange={closeAnnouncementDialog}
      >
          ...
          <div className="mt-4">
            ...
            {selectedAnnouncement?.ImpLink && (
              <div className="mt-4">
                ...
                <a
                  href={selectedAnnouncement.ImpLink}
                  target="_blank"
