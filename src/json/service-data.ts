  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: 'ECHO',
        icon: HeartPulse,
        description: 'Echocardiogram imaging to assess heart structure and function.',
        image: '/imaging/echo.jpg',
        details: [
          'Uses ultrasound waves to create detailed images of the heart',
          'Helps evaluate heart chambers, valves, and blood flow',
          'Essential for diagnosing heart failure, valve disease, and cardiomyopathy',
          'Non-invasive and painless procedure performed by skilled technicians',
          'Results interpreted by cardiologists for accurate diagnosis',
        ],
      },
